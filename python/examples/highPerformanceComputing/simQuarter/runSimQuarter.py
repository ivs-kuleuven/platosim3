...
"""
Usage: runSimQuarter.py <inputfile> <cameraGroupNr> <cameraNr> <quarterNr> [<logLevel>]
...
if (len(sys.argv) < 5) or (len(sys.argv) > 6):
    print("Usage:   $ python simQuarter.py <inputfile> <cameraGroupNr> <cameraNr> <quarterNr> [<logLevel>]")
    print("Example: $ python simQuarter.py inputfile.yaml 2 5 6")
    print("Example: $ python simQuarter.py inputfile.yaml 2 4 5 3")
    exit(1)
...
# Output will be stored in e.g. Run1_1_2_5.hdf5

outputFilePrefix = outputPrefix + "_{0:1d}_{1:1d}_{2:1d}".format(group, telescope, quarter)
