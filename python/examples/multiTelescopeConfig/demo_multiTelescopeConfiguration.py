...
Example script showing how to run the Plato Simulator for a multi-telescope configuration. The 24 telescopes are arranged in four groups of 6 telescopes.
