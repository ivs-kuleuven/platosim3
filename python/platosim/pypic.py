...
class PIC2101( PIC):
    ...
    def get_p1flag_including_known_planet_hosts( self):
        ...
        # In principle, P2 belongs to P1, but I am not including P2 here on purpose!
        return ( self.stellar_data[ 'tPICsourceFlagNCAM_BOL'] == 1) + ( self.stellar_data[ 'tPICsourceFlagNCAM_BOL'] == 17)
    ...
    #-----
    # PIC2101::get_scvPIC2eflag() returns an array with True value for the stars belonging to the SCV1e sample in the scvPIC (wide white dwarf binaries)
    # see chapter 3.1, page 18, in PLATO-SSDC-PDC-DD-0003 for the bitmask
    # see chapter 5, page 7, in PLATO-SSDC-PDC-DN-0001 for the numbers
