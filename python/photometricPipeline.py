...
from yamlConfigurable import YAMLconfigurable
...
class PhotometricPipeline(YAMLconfigurable):
    ...
    def __init__(self, runName, configurationFile, simulationFile, outputDir = None):
        ...
        if configurationFile != None:
            ...
            super().__init__(os.environ["PLATO_PROJECT_HOME"] + "/inputfiles/photometricPipeline.yaml")
