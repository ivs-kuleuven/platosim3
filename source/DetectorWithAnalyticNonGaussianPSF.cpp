 ...
 */
void DetectorWithAnalyticNonGaussianPSF::setInputParametersFromServer(int imagetteRows, int imagetteColumns, int startPointRow, int startPointCol, double offsetX, double offsetY, int orientation)
{
