...
/**
 * \brief checks whether the message is meant to change the window postion
 *  
 */
bool DetectorWithAnalyticNonGaussianPSF::checkWinPositionMessage(std::string winPositionString)
{
    ...
    {
        // TODO: Include consequences for received messages with the wrong number of arguments
