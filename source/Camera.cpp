...
: HDF5Writer(hdf5file), platform(platform), telescope(telescope), sky(sky), focalLength(nullptr), focalPlaneAngle(nullptr), internalTime(0.0),
 ...
 *      - calculate the sky coordinates of the centre of the sub-field;
