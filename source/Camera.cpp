...
: HDF5Writer(hdf5file), platform(platform), telescope(telescope), sky(sky), focalLength(nullptr), distortionCoef(nullptr), inverseDistortionCoef(nullptr), 
  internalTime(0.0), includeFieldDistortion(true), userGivenSkyBackground(-1.0), fluxOfV0Star(0.0) 
{
