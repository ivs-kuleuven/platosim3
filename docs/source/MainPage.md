...
The structure of the input file and the meaning of the individual configuration parameters are described in a separate document: <a href="_input_file_description.html">Description of the input file</a>.
