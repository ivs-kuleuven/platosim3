...
Once you have downloaded or updated the software, you have to @ref Building "build" it in order to be able to @ref Run "run" it.  The first time you download the software and on the rare occasions we update the dependencies (i.e. software packages we use in the code and that are distributed together with the PlatoSim3 code), you will have to resolve the dependencies (as described together with the build procedure). 
