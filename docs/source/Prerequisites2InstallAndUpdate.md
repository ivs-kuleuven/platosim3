# Prerequisites for Installing and Updating PlatoSim3 {#ReqsInstallUpdate}
...
<a href="https://github.com/IvS-KULeuven/PlatoSim3">PlatoSim3 repository</a> is kept private for now, access must be granted by the PlatoSim3 team explicitly.  Please, contact the developer team for this.
